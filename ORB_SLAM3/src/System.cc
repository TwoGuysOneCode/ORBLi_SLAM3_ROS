...
Sophus::SE3f System::TrackLidarStereo(const cv::Mat &imLeft, const cv::Mat &imRight, std::unordered_map<int, float> &lidarDepth, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename)
{
