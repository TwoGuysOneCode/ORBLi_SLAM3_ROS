...
Sophus::SE3f Tracking::GrabImageLidarStereo(const cv::Mat &imRectLeft, const cv::Mat &imRectRight, std::unordered_map<int, float> &lidarDepth, const double &timestamp, string filename)
{
    //cout << "GrabImageStereo" << endl;
